...
const PriceCard = (p:IPriceCardProps)=>{
  ...
  const extraClassName = el.id === product.default_price ? 'rounded-lg gradient':'rounded-none bg-white';
  ...
  <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <div className="flex items-center justify-center">
      <a className="mx-auto lg:mx-0 hover:underline gradient2 text-gray-800 font-bold rounded my-6 py-4 px-8 shadow-lg" href={getCheckout(el.id, p.email)} target="blank" >
        Purchase
      </a>
    </div>
  </div>
