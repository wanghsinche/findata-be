...
function Term(){
    ...
    <p>These terms and conditions outline the rules and regulations for the use of FinData's Website, located at https://findata-be.vercel.app/.</p>
    
    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use FinData if you do not agree to take all of the terms and conditions stated on this page.</p>
    ...
    <p>You must not:</p>
    <ul>
        <li>Republish material from FinData</li>
        <li>Sell, rent or sub-license material from FinData</li>
        <li>Reproduce, duplicate or copy material from FinData</li>
        <li>Redistribute content from FinData</li>
    </ul>
